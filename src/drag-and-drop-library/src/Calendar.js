...
class Calendar extends React.Component {
 static propTypes = {
   ...
   chargedHomeEnhancementsAccessor: accessor,
   chargedNeighborhoodEnhancementsAccessor: accessor,
   amountPaidAccessor: accessor,
 ...
 static defaultProps = {
   ...
   phoneAccessor: 'phone',
   emailAccessor: 'email',
   calendarAccessor: 'calendar',
   resourceIdAccessor: 'resourceId',
   durationAccessor: 'duration',
   dateAccessor: 'date',
   formsAccessor: 'forms',
   numberOfBathroomsAccessor: 'numberOfBathrooms',
   numberOfBedroomsAccessor: 'numberOfBedrooms',
   fireplaceEnhancementAccessor: 'fireplaceEnhancement',
   tvScreenEnhancementAccessor: 'tvScreenEnhancement',
   condominiumCommentsAccessor: 'condominiumComments',
   propertyCommentsAccessor: 'propertyComments',
   squareFootAccessor: 'squareFoot',
   howToAccessHomeAccessor: 'howToAccessHome',
   chargedHomeEnhancementsAccessor: 'chargedHomeEnhancements',
   chargedNeighborhoodEnhancementsAccessor: 'chargedNeighborhoodEnhancements',
   amountPaidAccessor: 'amountPaid',
   petsAccessor: 'pets',
